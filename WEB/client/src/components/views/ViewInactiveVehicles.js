...
class AdminInactiveVehicleItemsView extends Component {
    constructor(props) {
        super(props);
        this.state = {
            Vehicle: []
    ...
    componentDidMount() {
        axios.get(`http://localhost:8080/api/getAllInactiveItemsByType/${this.props.match.params.id}`)
            .then(response => {
...
export default AdminInactiveVehicleItemsView;
